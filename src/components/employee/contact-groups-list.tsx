...
export const ContactGroupsList = ({ groups }: { groups: Group[] }) => (
  <div className="p-6">
    ...
    {groups.length === 0 ? (
      <p className="text-slate-400 text-sm italic">No groups in common</p>
    ) : (
      <div className="space-y-3">
        {groups.map((group) => (
          <div key={group.id} className="flex items-center gap-3 p-3 rounded-lg hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
